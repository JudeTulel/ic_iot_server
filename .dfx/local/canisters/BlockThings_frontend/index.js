...
import { idlFactory } from './BlockThings_frontend.did.js';
export { idlFactory } from './BlockThings_frontend.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_BLOCKTHINGS_FRONTEND;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./BlockThings_frontend.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the BlockThings_frontend canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./BlockThings_frontend.did.js")._SERVICE>}
 */
export const BlockThings_frontend = createActor(canisterId);
